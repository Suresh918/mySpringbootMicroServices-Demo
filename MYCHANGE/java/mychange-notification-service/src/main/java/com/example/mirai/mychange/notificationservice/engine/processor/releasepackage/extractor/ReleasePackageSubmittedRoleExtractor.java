...
@Component("ReleasePackageSubmitted")
public class ReleasePackageSubmittedRoleExtractor extends ReleasePackageRoleExtractor implements RoleExtractorInterface {
    @Override
    public Set<BaseRole> getProcessors(Event event) throws IOException {

        this.category = "ReleasePackageSubmitted";
