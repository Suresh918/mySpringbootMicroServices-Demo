...
@Component("ReviewEntryCompleted")
public class ReviewEntryCompletedRoleExtractor implements RoleExtractorInterface {
	@Override
	...
	public Set<BaseRole> getProcessors(Event event) throws IOException {
		...
		//there will be exactly 1 review entry in review entry completed event
		...
		baseRoles.add(new ReviewEntryAssigneeRole(event, "ReviewEntryAssignee", reviewEntryAssignee, "ReviewEntryCompleted", Long.parseLong(id.toString()), entityId));
		return baseRoles;
	}
}
