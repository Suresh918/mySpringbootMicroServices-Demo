...
@Component("ReviewTaskDeleted")
public class ReviewTaskDeletedRoleExtractor implements RoleExtractorInterface {
	@Override
	public Set<BaseRole> getProcessors(Event event) throws IOException {
		...
		baseRoles.add(new ReviewTaskAssigneeRole(event, "ReviewTaskAssignee", reviewTaskAssignee, "ReviewTaskDeleted", Long.parseLong(id.toString()), entityId));
		return baseRoles;
	}
}
