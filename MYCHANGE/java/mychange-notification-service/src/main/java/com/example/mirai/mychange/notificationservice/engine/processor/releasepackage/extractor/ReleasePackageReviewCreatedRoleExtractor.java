...
@Component("ReleasePackageReviewCreated")
public class ReleasePackageReviewCreatedRoleExtractor extends ReleasePackageRoleExtractor implements RoleExtractorInterface {
    @Override
    public Set<BaseRole> getProcessors(Event event) throws IOException {
        this.category = "ReleasePackageReviewCreated";
