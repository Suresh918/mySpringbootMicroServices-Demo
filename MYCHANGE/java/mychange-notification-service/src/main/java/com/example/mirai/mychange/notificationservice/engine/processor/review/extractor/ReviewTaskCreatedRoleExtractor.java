...
@Component("ReviewTaskCreated")
public class ReviewTaskCreatedRoleExtractor implements RoleExtractorInterface {
	@Override
	public Set<BaseRole> getProcessors(Event event) throws IOException {
		...
		baseRoles.add(new ReviewTaskAssigneeRole(event, "ReviewTaskAssignee", reviewTaskAssignee, "ReviewTaskCreated", Long.parseLong(id.toString()), entityId));
		return baseRoles;
	}
}
