...
@Component("ReleasePackageReviewCompleted")
public class ReleasePackageReviewCompletedRoleExtractor extends ReleasePackageRoleExtractor implements RoleExtractorInterface {
    @Override
    public Set<BaseRole> getProcessors(Event event) throws IOException {
        this.category = "ReleasePackageReviewCompleted";
