...
@Component("ReleasePackageMyTeamMemberBulkReplaced")
public class ReleasePackageMyTeamMemberBulkReplacedRoleExtractor extends MyTeamMemberBulkRoleExtractor {
    public Set<BaseRole> getProcessors(Event event) throws IOException {
        this.category = "ReleasePackageMyTeamMemberBulkReplaced";
        Set<BaseRole> baseRoles = super.getProcessors(event);
        if (event.getStatus().equals("SUCCESS")) {
            baseRoles.add(new MyTeamMemberBulkUpdateRole(event, "MyTeamMember", addedMyTeamMember, "ReleasePackageMyTeamMemberBulkAdded", null, null));
            baseRoles.add(new MyTeamMemberBulkUpdateRole(event, "MyTeamMember", removedMyTeamMember, "ReleasePackageMyTeamMemberBulkReplaced", null, null));
        }
