...
@Setter
@Getter
public class ChangeSpecialist2Role extends ReleasePackageRole {

    public ChangeSpecialist2Role(Event event, String role, User changeSpecialist2, String category, Long entityId, Long id) throws JsonProcessingException {
        super(event, role, category, entityId, id);
        this.recipient = changeSpecialist2;
    }
