...
@Component("ReleasePackageMyTeamMemberBulkAdded")
public class ReleasePackageMyTeamMemberBulkAddedRoleExtractor extends MyTeamMemberBulkRoleExtractor {
    public Set<BaseRole> getProcessors(Event event) throws IOException {
        this.category = "ReleasePackageMyTeamMemberBulkAdded";
