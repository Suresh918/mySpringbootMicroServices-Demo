...
@Component("ChangeRequestRedrafted")
public class ChangeRequestRedraftedRoleExtractor extends ChangeRequestRoleExtractor {

	@Override
	public Set<BaseRole> getProcessors(Event event) throws IOException {
		this.category = "ChangeRequestRedrafted";
